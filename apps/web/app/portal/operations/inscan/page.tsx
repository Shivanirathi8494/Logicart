  ...
  async function inscanShipment() {
    ...
    try {
      ...
      window.location.replace(
        "/portal/operations/search-docket"
      );
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 text-slate-500">
          Verify the physical shipment before receiving it into the origin branch warehouse.
        </p>
...
function VerificationRow({
  ...
  return (
    <div className="grid grid-cols-3 items-center border-t text-sm">
      ...
      <div className="p-3 font-medium text-slate-600 sm:p-4">
        {label}
      </div>

      <div className="p-3 font-semibold text-slate-700 sm:p-4">
        {booked}
      </div>
